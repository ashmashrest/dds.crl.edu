...
class SelectDecorator extends Select implements PlatformDecoratorInterface
{
    ...
    protected function processLimitOffset(PlatformInterface $platform, DriverInterface $driver = null, ParameterContainer $parameterContainer = null, &$sqls, &$parameters)
    {
        ...
        if ($parameterContainer) {
           ...
           array_push($sqls, ') AS [ZEND_SQL_SERVER_LIMIT_OFFSET_EMULATION] WHERE [ZEND_SQL_SERVER_LIMIT_OFFSET_EMULATION].[__ZEND_ROW_NUMBER] BETWEEN :offset+1 AND :limit+0+:offset');
